function educational(data) {
    ...
    changeCSS("../../mypage/educational/educationalbackground.css", 0);
    ...
    w = w + '<p class="contents">学校種別</p><p><select name="schooltype">';
    ...
    w = w + '<p class="contents">専攻</p><p><select name="major">';
    ...
    w = w + '<p class="contents">入学年月日</p><p><input class="date" type="date" name="admissiondate"></p>';
    w = w + '<p class="border"></p>';

    w = w + '<p class="contents">卒業年月日<p/><p><input class="date" type="date" name="graduatedate"></p>';
    w = w + '<p class="border"></p>';

    w = w + '<p class="contents">卒業区分</p><p><select name="category">';
    w = w + '<option value="">--</option><option value="卒業">卒業</option><option value="卒業見込み">卒業見込み</option><option value="中退">中退</option>';
    w = w + '</select></p><p class="border"></p></section>';

    w = w + '</form><button class="add" type="button">学歴を追加する</button></article>';
