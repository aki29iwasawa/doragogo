function writeregistration(data) {
    ...
    changeCSS("registration.css", 0);

    var w = '<article><form action="#" name="form"><button class="save" type="button" id="save">保存</button><h1>個人情報を編集</h1>';
    ...
    w = w + '<p class="contents">メール</p><p><input id="email"></input><button class="save" type="button" id="mail-edit"">編集</button></p><p class="border"></p>';
    w = w + '<p class="contents">電話番号</p><p><input id="tel"></input><button class="save" type="button" id="tel-edit"">編集</button></p><p class="border"></p>';
    w = w + '<p class="contents"></p><p class="certificate">身分証明書<button class="save" type="button" id="cert-edit"">編集</button></p><p class="border"></p</form></article>';
